...
import numpy as np
import LabelSpacePartition as lsp
...
trans_result1 = lp.transform(y_train_train1)
trans_result2 = lp.transform(y_train_train2)
trans_result = [trans_result1]
trans_result.append(trans_result2)

# Fit using lp
lsp_fit = lsp.fit(X_train_train,trans_result,cluster)
lsp_pred = lsp.predict(lsp_fit ,X_train_test,trans_result).toarray()
